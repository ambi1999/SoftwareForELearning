...
//code added by Ambikesh Jayal, ambikesh.jayal@brunel.ac.uk
private static PaiceJava2 paiceJava2=null;

//singleton method
public static PaiceJava2 getSingletonInstance(String rules, String pre){
    if(paiceJava2==null){
        paiceJava2=new PaiceJava2 (rules, pre);
    }
    return paiceJava2;
}

public static PaiceJava2 getSingletonInstance(){
    if(paiceJava2==null){
        paiceJava2=new PaiceJava2 ();
    }
    return paiceJava2;
}
...
*Purpose:	init		*
********************************/
public PaiceJava2 (String rules, String pre)
	{
...
//code by ambi on 09 March 2008

//by ambi on 09 March 2008
public PaiceJava2 ()
	{
	String rules;
	String pre;

	//rules="C:/01Am/01_Res EAss/02-Work/Stemming/Java Implementations for stemming/Java/stemrules.txt";
        rules=CommonPaths.PaiceHusk_Stemmer_RULES_FILE_PATH;
	pre="/p";
...
public PaiceJava2 (String pre)
	{
	String rules;

	//rules="C:/01Am/01_Res EAss/02-Work/Stemming/Java Implementations for stemming/Java/paicejava.txt";
	rules=CommonPaths.PaiceHusk_Stemmer_RULES_FILE_PATH;
...
//str1 can be a single word or a combination of words.
public static String getStemWord(String inputText){
...
line= new StringTokenizer(inputText);
	try{
		while (line.hasMoreTokens())
			...
			outputText=p.stripAffixes(word);
			}else{
			outputText=outputText+ " " + p.stripAffixes(word);
			}
...
//strInputText="warning";

/*
for(int i=0;i<args.length;i++){
strInputText=strInputText+args[i];
}
*/

//strInputText=args[0];

strInputText="updated the existing balanced";

System.out.println("processForInbetweenSpace(strInputText): ["+processForInbetweenSpace(strInputText)+"]");

PaiceJava2 paiceJava = new PaiceJava2();

strStemText=paiceJava.getStemWord(strInputText);

System.out.println("strStemText: ["+strStemText+"]");

System.out.println("2222222222: ["+paiceJava.getStemWord("industrial emperimentation")+"]");

//testing
String str1="    hello   the     india to of     uk   ";
String[] arrString1=str1.split(" ");
List listString1=new ArrayList();
                for(int i=0;i<arrString1.length;i++){
					System.out.println("arrString1[i]: ["+arrString1[i]+"]");
                    listString1.add(arrString1[i]);
                }
System.out.println("1 listString1: ["+listString1+"]");
listString1.remove("the");
System.out.println("2 listString1: ["+listString1+"]");
...
public static String processForInbetweenSpace(String inputText){
		...
		/*
		String strSpace=UMLToolConstants.SPACE;
		String strReplacement=UMLToolConstants.REPLACEMENT_CHARACTER1;
		str1=str1.replaceAll(strSpace,strReplacement);
		*/
		StringTokenizer line = new StringTokenizer("");
		String outputText ="";
